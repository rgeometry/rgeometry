...
sourcesIndex["rgeometry"] = {"name":"","dirs":[{"name":"algorithms","dirs":[{"name":"convex_hull","files":["graham_scan.rs","mod.rs"]},{"name":"intersection","files":["naive.rs"]},{"name":"triangulation","files":["earclip.rs"]}],"files":["intersection.rs","polygonization.rs","triangulation.rs","zhash.rs"]},{"name":"data","dirs":[{"name":"point","files":["add.rs","sub.rs"]},{"name":"polygon","files":["convex.rs","iter.rs"]},{"name":"vector","files":["add.rs","div.rs","mul.rs","sub.rs"]}],"files":["directed_edge.rs","intersection_set.rs","line_segment.rs","point.rs","polygon.rs","triangle.rs","vector.rs"]}],"files":["algorithms.rs","array.rs","data.rs","intersection.rs","lib.rs","matrix.rs","transformation.rs","utils.rs"]};
createSourceSidebar();
